...
```
docker pull snazzybucket/idris2:v0.6.0-194-ga00b7ee7e
```
...
If there's been no commits to master, the images are still rebuilt. I'm not sure if the docker image SHAs will remain the same, but if you pull say tag `:v0.6.0-194-ga00b7ee7e` twice and get different SHAs, that's probably what happened.
